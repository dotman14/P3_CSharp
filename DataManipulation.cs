...
//                    Elect.SearchByOffice(office); //search the entries and display them
//                    break;
...
//                    Elect.SearchByState(state); //search the entries and display them
//                    break;
//                case '3': //search by county
//                    Console.Write("\nName of County: ");
//                    var county = Console.ReadLine();
//                    Display.GetMainHeader();
//                    Elect.SearchByCounty(county);
//                    break;
...
//            do
//            {
//                Console.Write("Select Office: Ex..{0}: ", Elect.AllTypesOfElections());
...
//            if (!Elect.CheckUniqueData(state, county, year, office))        //check if the entry exists
...
//                    badInput = false;
//                    Display.GetMainHeader();
//                    Console.WriteLine(Elect.GetSingleRow(state, county, year, office));
...
//                Elect.Add(newElec);                                   //add the object to the list
//                Console.WriteLine("\n Input Added\n");
//                Display.GetMainHeader();
...
//        {
//            var index = Elect.GetIndex(state, county, year, office);    //get the index of the entry to modify 
//            if (index < 0)
//            {
//                Console.WriteLine("Sorry, we have no data for that election");
//                return;
//            }
//            var beforeUpdate = Elect.GetSingleRow(state, county, year, office); //get the row to modify
